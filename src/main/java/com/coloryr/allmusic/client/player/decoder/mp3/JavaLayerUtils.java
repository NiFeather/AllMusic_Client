...
public class JavaLayerUtils {
    ...
    private static final Logger log = LoggerFactory.getLogger(JavaLayerUtils.class);
    ...
    {
        var resourceId = Identifier.of("allmusic", "bin/" + name);

        var resource = MinecraftClient.getInstance().getResourceManager()
                .getResource(resourceId).orElse(null);
        ...
        {
            log.error("Can't open %s for read: %s".formatted(resourceId, t.getMessage()));
            t.printStackTrace();
